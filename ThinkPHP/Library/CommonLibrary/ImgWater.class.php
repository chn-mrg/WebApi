...
// 写水印动作
    public function waterInfo($ground,$water,$pos=0,$prefix="lee_"){
...
//整合资源
        $newGround=$this->imgCopy($groundRes,$waterRes,$newPos,$waterInfo);

//保存资源
        return $this->saveImg($newGround,$ground,$groundInfo['mime'],$prefix);
    ...
    private function imgCopy($ground,$water,$pos,$waterInfo){
        imagecopy($ground,$water,$pos[0],$pos[1],0,0,$waterInfo[0],$waterInfo[1]);
        return $ground;
    }
