...
class XssHtml
{
    ...
    private $m_xss;
    private $m_ok;
    private $m_AllowAttr = array('controls', 'title', 'src', 'href', 'id', 'class', 'style', 'width', 'height', 'alt', 'target', 'align');
    private $m_AllowTag = array('audio', 'a', 'img', 'br', 'strong', 'b', 'code', 'pre', 'p', 'div', 'em', 'span', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'table', 'ul', 'ol', 'tr', 'th', 'td', 'hr', 'li', 'u');
    ...
    public function getHtml()
    {
        ...
        $html = strip_tags(urldecode($this->m_dom->saveHTML()), '<' . implode('><', $this->m_AllowTag) . '>');
        $html = preg_replace('/^\n(.*)\n$/s', '$1', $html);
        return $html;
    }
